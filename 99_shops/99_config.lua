Config = {
    ...
    Locales = {
        ...
        ["drinks"] = "Pića",
        ["snacks"] = "Grickalice",
        ["readymeal"] = "Gotova jela",
        ["diverse"] = "Ostalo",
    },

    Items = {
        ["drinks"] = {
            {label = "Voda", item = "water", price = 3},
        ...
        ["readymeal"] = {
            {label = "Kruh", item = "bread", price = 5},
            --{label = "Bacon Burgare", item = "burger", price = 27},
            --{label = "Pasta Carbonara", item = "pastacarbonara", price = 18},
            --{label = "Skinkmacka", item = "macka", price = 8},
        },
        ["diverse"] = {
            --{label = "Cigarett", item = "cigarett", price = 10},
            --{label = "Tändare", item = "lighter", price = 20},
            {label = "Alat za popravak auta", item = "fixtool", price = 150},
        },
    },
}