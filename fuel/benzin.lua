...
Config.Strings = {
	ExitVehicle = "Izadi iz vozila da ga napunis",
	EToRefuel = "Pritisni ~g~E ~w~da ponovo napunis vozilo",
	JerryCanEmpty = "Kanister je prazan",
	FullTank = "Rezervar je pun",
	PurchaseJerryCan = "Pritisni ~g~E ~w~da kupis kanister za ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Pritisni ~g~E ~w~to cancel the fueling",
	CancelFuelingJerryCan = "Pritisni ~g~E ~w~to cancel the fueling",
	NotEnoughCash = "Not enough cash",
	RefillJerryCan = "Pritisni ~g~E ~w~ da napunis kanister za ",
	NotEnoughCashJerryCan = "Nemas dovoljno novaca da napunis kanister",
	JerryCanFull = "Kanister je pun",
	TotalCost = "Cost",
}
