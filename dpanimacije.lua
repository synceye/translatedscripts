...
['hr'] = {
        ['emotes'] = 'Animacije',
        ['danceemotes'] = "Plesanje | 🕺",
        ['propemotes'] = "Objekti | 📦",
        ['favoriteemotes'] = "Omiljeno | 🌟",
        ['favoriteinfo'] = "Izaberi animaciju da stavis u tvoje omiljene.",
        ['rfavorite'] = "Resetaj omiljene animacije",
        ['prop2info'] = "❓ Objetki mogu biti nadjeni na dnu",
        ['set'] = "Postavi (",
        ['setboundemote'] = ") na tvoju tipkovnicu?",
        ['newsetemote'] = "~w~ je sada stavljen na tvoju tipkovnicu, pritisni ~g~CapsLock~w~ da ga koristis.",
        ['cancelemote'] = "Prekini animaciju",
        ['cancelemoteinfo'] = "~r~X~w~ Prekida animaciju u tijeku",
        ['walkingstyles'] = "Stilovi hoda",
        ['resetdef'] = "Stavi na default",
        ['normalreset'] = "Normalbo (Reset)",
        ['moods'] = "Raspoloženja",
        ['infoupdate'] = "Informacije",
        ['infoupdateav'] = "Informacije (Update dostupan)",
        ['infoupdateavtext'] = "Update je dostupan, skini ga s: ~y~https://github.com/andristum/dpemotes~w~, ali ostavi ovaj file ovdje",
        ['suggestions'] = "Preporuke?",
        ['suggestionsinfo'] = "'dullpear_dev' na FiveM forumu za bilo koje dodatke | ✉️",
        ['notvaliddance'] = "nije tocan ples.",
        ['notvalidemote'] = "nije tocna animacija.",
        ['nocancel'] = "Nema animacije za prekinuti.",
        ['maleonly'] = "Ova animacija je samo za muske, sorry!",
        ['emotemenucmd'] = "Unesi /emotemenu za meni.",
        ['shareemotes'] = "Zajednicke animacije | 👫",
        ['shareemotesinfo'] = "Pozovi covjeka u blizini",
        ['sharedanceemotes'] = "Zajednicki plesovi | 🕺",
        ['notvalidsharedemote'] = "nije tocna zajednicka animacija.",
        ['sentrequestto'] = "Poslao zahtjev ~y~",
        ['nobodyclose'] = "Nitko ~r~nije~w~ blizu.",
        ['doyouwanna'] = "~y~Y~w~ da prihatis, ~r~L~w~ da odbis (~g~",
        ['refuseemote'] = "Animacija odbijena.",
        ['makenearby'] = "napravi da drugi plese",
        ['camera'] = "Pritisni ~y~G~w~ da koristis kameru.",
        ['makeitrain'] = "Pritisni ~y~G~w~ da flexas.",
        ['pee'] = "Drzi ~y~G~w~ da obavis kratku nuzdu.",
        ['spraychamp'] = "Drzi ~y~G~w~ da prskas sa sampanjcem",
        ['bound'] = "Boundaj ",
        ['to'] = "na",
        ['currentlyboundemotes'] = "Upravo boundane animacije:",
        ['notvalidkey'] = "nije dobra tipka.",
        ['keybinds'] = "Tipke | 🔢",
