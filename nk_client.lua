...
AddEventHandler('nk_repair:MettiCrick', function(ped, coords, veh)
	...
	exports['progressBars']:startUI(9250, "Postavljanje dizalice") -- TRANSLATE THIS, THAT SAY WHEN YOU PUT THE CRIC
	...
	exports['progressBars']:startUI(11000, "Popravljanje vozila") -- TRANSLATE THIS - THAT SAY WHEN YOU REPAIR THE VEHICLE
	...
	exports['progressBars']:startUI(8250, "Micanje dizalice") -- TLANSTALE THIS - THAT SAY WHEN YOU LEAVE THE CRIC
	TaskPlayAnimAdvanced(ped, dict, 'car_bomb_mechanic', coords, 0.0, 0.0, headin, 1.0, 0.5, 1250, 1, 0.0, 1, 1)
	Citizen.Wait(1250)
	SetEntityCoordsNoOffset(veh, vehpos.x, vehpos.y, vehpos.z + 0.4, true, true, true)
	TaskPlayAnimAdvanced(ped, dict, 'car_bomb_mechanic', coords, 0.0, 0.0, headin, 1.0, 0.5, 1000, 1, 0.25, 1, 1)
...
AddEventHandler('nk_repair:MenuRipara', function()
	...
	if DoesEntityExist(veh) then
		if IsEntityAVehicle(veh) then
			...
			ESX.ShowNotification('Nema vozila u ~y~blizini~s~!') -- TRANSLATE THIS - THAT SAY WHEN YOU DON'T HAVE ANY VEHICLE IN THE NEAR
		end
	end
end)
